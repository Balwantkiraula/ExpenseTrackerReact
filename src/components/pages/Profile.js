...
const Profile = () =>{
    ...
    useEffect(async ()=>{
        ...
        const res = await fetch('https://identitytoolkit.googleapis.com/v1/accounts:lookup?key=AIzaSyAJcNKKSIcUVsLmg9FdEsajZCwyPCR5cZw',{
            method:'POST',
            body:JSON.stringify({
                idToken:id,
    ...
    const submitHandler=async (e)=>{
        ...
        const res = await fetch('https://identitytoolkit.googleapis.com/v1/accounts:update?key=AIzaSyAJcNKKSIcUVsLmg9FdEsajZCwyPCR5cZw',{
            method:'POST',
            body:JSON.stringify({
                idToken:user,
