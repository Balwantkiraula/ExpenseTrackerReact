...
async function updateUserProfile(details) {
  const firebaseApiUrl = `https://identitytoolkit.googleapis.com/v1/accounts:update?key=AIzaSyAJcNKKSIcUVsLmg9FdEsajZCwyPCR5cZw`;
...
async function getUserProfile(idToken) {
  const firebaseApiUrl = `https://identitytoolkit.googleapis.com/v1/accounts:lookup?key=AIzaSyAJcNKKSIcUVsLmg9FdEsajZCwyPCR5cZw`;
...
async function verifyEmail(idToken) {
  const firebaseApiUrl = `https://identitytoolkit.googleapis.com/v1/accounts:sendOobCode?key=AIzaSyAJcNKKSIcUVsLmg9FdEsajZCwyPCR5cZw`;
